...
const Sidebar = () => {
  ...
  const sortedUsers = filteredUsers.sort((a, b) => {
    const lastMessageTimeA = getLastMessageTime(a._id);
    const lastMessageTimeB = getLastMessageTime(b._id);
        ...
        {sortedUsers.map((user) => (
          ...
          >
            ...
            >
              ...
              <div className="text-sm text-zinc-400">{user.school}</div> {/* Add school */}
              {unreadMessages[user._id] && (
                <div className="text-xs text-red-500">
                  {unreadMessages[user._id]} unread message(s)
                </div>
              )}
            </button>
          </div>
